...
//                get the service provider id using the issuer
    ...
    private void processAddServiceProvider(Connection connection, SAMLSSOServiceProviderDO serviceProviderDO)
        ...
        try (NamedPreparedStatement statement = new NamedPreparedStatement(connection,
            ...
            statement.setString(QUERY_REQUEST_PROFILE_ENABLED, serviceProviderDO.isAssertionQueryRequestProfileEnabled() ? "1" : "0");
            ...
            statement.setString(ARTIFACT_RESOLVE_REQ_SIG_VALIDATION, serviceProviderDO.isDoValidateSignatureInArtifactResolve() ? "1" : "0");
            ...
            statement.setString(SUPPORTED_ASSERTION_QUERY_REQUEST_TYPES, serviceProviderDO.getSupportedAssertionQueryRequestTypes());
    ...
    private void processAddCustomAttributes(int serviceProviderId, Connection connection,
        ...
        try (NamedPreparedStatement statement = new NamedPreparedStatement(connection,
            ...
            for (ConfigTuple customAttribute : customAttributes) {
                ...
                statement.setString(DEFAULT_FLAG, isDefaultAssertionConsumerUrl(serviceProviderDO, key, value) ? "1" : "0");
                statement.setInt(TENANT_ID, tenantId);
                statement.addBatch();
            }
    ...
    private List<ConfigTuple> processGetCustomAttributes(Connection connection, int serviceProviderId, SAMLSSOServiceProviderDO serviceProviderDO) throws SQLException {
    ...
    private SAMLSSOServiceProviderDO resourceToObject(ResultSet resultSet) throws SQLException {
        ...
        serviceProviderDO.setAssertionQueryRequestProfileEnabled(getBooleanValue(resultSet.getString(QUERY_REQUEST_PROFILE_ENABLED)));
        ...
        serviceProviderDO.setDoValidateSignatureInArtifactResolve(getBooleanValue(resultSet.getString(ARTIFACT_RESOLVE_REQ_SIG_VALIDATION)));
        ...
        serviceProviderDO.setSupportedAssertionQueryRequestTypes(resultSet.getString(SUPPORTED_ASSERTION_QUERY_REQUEST_TYPES));
//        serviceProviderDO.setTenantId(resultSet.getInt(TENANT_ID));
    ...
    private boolean isDefaultAssertionConsumerUrl(SAMLSSOServiceProviderDO serviceProviderDO, String key, String value) {
    ...
    private SAMLSSOServiceProviderDO addProperties(Connection connection, int serviceProviderId, SAMLSSOServiceProviderDO serviceProviderDO) throws SQLException {
