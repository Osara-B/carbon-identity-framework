...
public class SAMLSSOServiceProviderDO implements Serializable {
    ...
    public SAMLSSOServiceProviderDO(SAMLSSOServiceProviderDO samlSSOServiceProviderDO) {
        ...
        this.assertionConsumerUrls = samlSSOServiceProviderDO.assertionConsumerUrls != null ? samlSSOServiceProviderDO.assertionConsumerUrls.clone() : null;
        this.assertionConsumerUrlList = samlSSOServiceProviderDO.assertionConsumerUrlList != null ? new ArrayList<>(samlSSOServiceProviderDO.assertionConsumerUrlList) : null;
        ...
        this.requestedClaims = samlSSOServiceProviderDO.requestedClaims != null ? samlSSOServiceProviderDO.requestedClaims.clone() : null;
        this.requestedClaimsList = samlSSOServiceProviderDO.requestedClaimsList != null ? new ArrayList<>(samlSSOServiceProviderDO.requestedClaimsList) : null;
        this.requestedAudiences = samlSSOServiceProviderDO.requestedAudiences != null ? samlSSOServiceProviderDO.requestedAudiences.clone() : null;
        this.requestedAudiencesList = samlSSOServiceProviderDO.requestedAudiencesList != null ? new ArrayList<>(samlSSOServiceProviderDO.requestedAudiencesList) : null;
        this.requestedRecipients = samlSSOServiceProviderDO.requestedRecipients != null ? samlSSOServiceProviderDO.requestedRecipients.clone() : null;
        this.requestedRecipientsList = samlSSOServiceProviderDO.requestedRecipientsList != null ? new ArrayList<>(samlSSOServiceProviderDO.requestedRecipientsList) : null;
        ...
        this.idpInitSLOReturnToURLs = samlSSOServiceProviderDO.idpInitSLOReturnToURLs != null ? samlSSOServiceProviderDO.idpInitSLOReturnToURLs.clone() : null;
        this.idpInitSLOReturnToURLList = samlSSOServiceProviderDO.idpInitSLOReturnToURLList != null ? new ArrayList<>(samlSSOServiceProviderDO.idpInitSLOReturnToURLList) : null;
